            ...
            <div class="container-fluid px-lg-5">
                ...
                <nav class="py-4">
                    ...
                    <ul class="menu mt-2">
                        ...
                        <li class="active"><a href="collections.jsp">Collections</a></li>
    ...
    <section class="ab-info-main py-5">
        <div class="container py-lg-3">
            <div class="ab-info-grids">
                <h3 class="tittle text-center mb-lg-5 mb-3">Collections</h3>
                <div id="products" class="row view-group">
                    <div class="item col-lg-4">
                        <div class="thumbnail card">
                            <div class="img-event">
                                <img class="group list-group-image img-fluid" src="images/aid.jpg" alt="" />
                            </div>
                            <div class="caption card-body">
                                <h4 class="group card-title inner list-group-item-heading">
                                    Medicines</h4>
                                <p class="group inner list-group-item-text">
                                    First aid kit and other basic required medicines.</p>
                                <div class="row">
                                    <div class="col-6 ban-buttons">
                                        <a class="btn btn-course" href="request.jsp">Need</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item col-lg-4">
                        <div class="thumbnail card">
                            <div class="img-event">
                                <img class="group list-group-image img-fluid" src="images/kitchenacc.jpg" alt="" />
                            </div>
                            <div class="caption card-body">
                                <h4 class="group card-title inner list-group-item-heading">
                                    Kitchen Accessories</h4>
                                <p class="group inner list-group-item-text">
                                   We provide required kitchen accessories for cooking.</p>
                                <div class="row">
                                    <div class="col-6 ban-buttons">
                                        <a class="btn btn-course" href="request.jsp">Need</a>
                                    </div>
                    ...
                    <div class="item col-lg-4">
                        <div class="thumbnail card">
                            <div class="img-event">
                                <img class="group list-group-image img-fluid" src="images/adult.jpg" alt="" />
                            </div>
                            <div class="caption card-body">
                                <h4 class="group card-title inner list-group-item-heading">
                                    Adult Clothes</h4>
                                <p class="group inner list-group-item-text">
                                    Clothes for adult ages, donated by different DONORS.</p>
                                <div class="row">
                                    <div class="col-6 ban-buttons">
                                        <a class="btn btn-course" href="request.jsp">Need</a>
                                    </div>
                    ...
                    <div class="item col-lg-4 mt-lg-4">
                        <div class="thumbnail card">
                            <div class="img-event">
                                <img class="group list-group-image img-fluid" src="images/chield.jpg" alt="" />
                            </div>
                            <div class="caption card-body">
                                <h4 class="group card-title inner list-group-item-heading">
                                    Children Clothes</h4>
                                <p class="group inner list-group-item-text">
                                    Clothes for children's ages between 6 month's to 10 years.</p>
                                <div class="row">
                                    <div class="col-6 ban-buttons">
                                        <a class="btn btn-course" href="request.jsp">Need</a>
                                    </div>
                    ...
                    <div class="item col-lg-4 mt-lg-4">
                        <div class="thumbnail card">
                            <div class="img-event">
                                <img class="group list-group-image img-fluid" src="images/menwomen.jpg" alt="" />
                            </div>
                            <div class="caption card-body">
                                <h4 class="group card-title inner list-group-item-heading">
                                    Men & Women</h4>
                                <p class="group inner list-group-item-text">
                                    Clothes for men and women ages between 25 to 40 years.</p>
                                <div class="row">
                                    <div class="col-6 ban-buttons">
                                        <a class="btn btn-course" href="request.jsp">Need</a>
                                    </div>
                    ...
                    <div class="item col-lg-4 mt-lg-4">
                        <div class="thumbnail card">
                            <div class="img-event">
                                <img class="group list-group-image img-fluid" src="images/foot.jpg" alt="" />
                            </div>
                            <div class="caption card-body">
                                <h4 class="group card-title inner list-group-item-heading">
                                    Footwear and More</h4>
                                <p class="group inner list-group-item-text">
                                    And also footwear and other available collections.</p>
                                <div class="row">
                                    <div class="col-6 ban-buttons">
                                        <a class="btn btn-course" href="request.jsp">Need</a>
                                    </div>
