...
<%
	...
	<section class="ab-info-main py-5">
	   <h3 class="tittle text-center"><span class="sub-tittle"></span> View Recent Activities</h3>
        <br>
        <br>
        <div class="ban-buttons" align="center">
            <a href="ActDon.jsp" class="btn active1">Recent Donations</a>&nbsp &nbsp &nbsp 
            <a href="ActReq.jsp" class="btn active1" style="background-color: black">Recent Requests</a>
        </div>&nbsp;
    </section><br/>
    <!-- //contact -->
    <!-- footer -->
