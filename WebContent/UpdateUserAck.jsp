...
<section>
 ...
 <section>
    ...
    <div align="center">
		...
		<h5 style="color:gray">User record has been updated successfully. Page will redirect in 3 seconds.</h5>
	</div>
	<br>
	<br>
    ...
    <script>
        setTimeout(function () {
            window.location.replace("UserDetails.jsp"); //will redirect to main page (index.jsp)
