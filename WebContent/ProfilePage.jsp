       ...
       <div class="login_icons">
        ...
        PreparedStatement pstatement = null;
         ...
         Class.forName("oracle.jdbc.OracleDriver").newInstance();
              ...
              pstatement=connection.prepareStatement("SELECT * FROM PGSREGISTER WHERE MAILID=?");
              ...
              <div >
        			...
        			<div class="address-con">
                        <h4 class="mb-2"><span class="fa fa-user" aria-hidden="true"></span> User Name</h4>
                        <p><%=rt.getString("USER_NAME") %></p>
                    
                    </div>
        			
                    <div class="address-con">
                        <h4 class="mb-2"><span class="fa fa-envelope-o" aria-hidden="true"></span> Email Address</h4>
                        <p><%=rt.getString("MAILID") %></p>
                    </div>
                    
                    <div class="address-con">
                        <h4 class="mb-2"><span class="fa fa-phone" aria-hidden="true"></span> Phone Number</h4>
                        <p><%=rt.getString("PHONE_NO") %></p>
                    <div class="ban-buttons" align="center">
            <a href="ProfileUpdate.jsp?ID=<%=rt.getString("ID") %>" class="btn active1" style="background-color: black; border-radius: 20px;">UPDATE</a>
              </div>
