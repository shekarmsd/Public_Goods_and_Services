...
<h3 class="tittle text-center"><span class="sub-tittle"></span> Recent Donation Forms</h3><br>
	<div align="center"style="overflow-x:auto;" >
	        ...
	        PreparedStatement pstatement = null;
	         ...
	         Class.forName("oracle.jdbc.OracleDriver").newInstance();
	              ...
	              pstatement=connection.prepareStatement("SELECT * FROM DONATION_FORM WHERE MAILID=?");
	              ...
	              <%  while(rt.next()){ %>
					...
					<td><%=rt.getString("ADDRESS_LINE1") %></td>
					<td><%=rt.getString("ADDRESS_LINE2") %></td>
					<td><%=rt.getString("PINCODE") %></td>
					<td><%=rt.getString("STATE") %></td>
					<td><%=rt.getString("GOODS_ONE") %></td>
					<td><%=rt.getString("GOODS_TWO") %></td>
					<td><%=rt.getString("GOODS_THREE") %></td>
