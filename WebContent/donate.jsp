...
<section class="ab-info-main py-md-5">
    <h2 style="color: #c89666; text-align: center;">You're little things gonna be big things, we proud of your helpful nature.</h2>
    <form action="Donation_Form" method="post" class="mt-4" onSubmit="return check();">
        <div class="container py-md-3">
            <h3 class="tittle text-center mb-lg-5 mb-3">We APPRECIATE YOUR DONATION</h3>
            <div class="single-form-left">
                <!-- contact form grid -->
                <div class="contact-single">
                    <p style="color: #12343b; text-align: center;">Choose what you would like to DONATE *</p>
                    <div class="d-sm-flex">
                        <div class="check">
                    ...
                    <div class="form-group">
                        <label for="address1">Address Line 2 (optional)</label>
                        <textarea class="form-control border" rows="2" id="address1" name="address1"></textarea>
                    </div>
                    <div class="d-sm-flex">
                        <div class="col-sm-6 form-group p-0">
                    ...
                    <button type="submit" class="mt-3 btn btn-success btn-block py-3">BECOME A DONOR</button>
                </div>
